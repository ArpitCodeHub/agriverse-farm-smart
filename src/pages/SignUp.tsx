    ...
    <div className="min-h-screen bg-gradient-growth flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="bg-card/80 backdrop-blur-sm border-primary-foreground/20 animate-scale-in">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-secondary/20 border border-secondary/30 rounded-lg p-4 text-center">
              <h3 className="font-semibold text-secondary mb-2">Connect Supabase to Enable Authentication</h3>
              <p className="text-sm text-muted-foreground mb-3">
                To enable Google OAuth and email authentication, connect your project to Supabase using the green button in the top-right corner.
              </p>
        ...
        <div className="text-center mt-6">
          <Link 
            to="/home" 
            className="text-primary-foreground/80 hover:text-primary-foreground text-sm hover:underline"
          >
